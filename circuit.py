...
def load_config(config_file_path):
    ...
    print("Num 2-qubit gates: ", p)
    print("Num 1-qubit gates: ", q)
    print("Weak link penalty: ", alpha)

    return q, p, alpha, delta, gamma, qubits_per_chain, num_qubits, num_chains, qubit_placement, cut_sizes, indices, operation_list


def gen_random_circuit(chain_length, number_of_qubits, number_of_2q_gates, weak_link_penalty):
    ...
    num_2q_gates = number_of_2q_gates
...
def gen_supremacy(chain_length):
...
def gen_squareroot(chain_length):
...
def gen_QV(chain_length, number_of_qubits, number_of_2q_gates, weak_link_penalty):
